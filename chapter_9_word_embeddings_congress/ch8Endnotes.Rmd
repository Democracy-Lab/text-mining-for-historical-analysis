...
The first plot we will look at from the Congress Viewer shows the semantic association of words over time. The visualization is a type of scatter plot where the x-axis is a timeline ranging from 1900 to 2025. The following visualization examines the word "democracy." For most of the twentieth century, the words most closely associated with democracy are fairly unsurprising: terms such as "patriotism," "freedom," "liberty," "victory," and "win." These associations largely carry a positive tone, and many are connected to words like "unity" and "peace."
