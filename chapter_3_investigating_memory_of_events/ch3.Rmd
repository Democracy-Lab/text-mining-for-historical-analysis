...
In this visualization, you may notice that we have produced a different sort of visualization than the bar charts we have been creating. `ggplot2` is a flexible library for creating many different types of visualizations from the same dataset. Rather than the command for a bar chart -- `geom_col()` -- we have used a command for a dot plot -- `geom_point()`. 
