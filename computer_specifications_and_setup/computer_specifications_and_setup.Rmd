...
Additionally, it is worth closing out of other tabs or programs when running the code in this book to free up computer memory and help the analyses run smoothly, especially when working with large datasets.
