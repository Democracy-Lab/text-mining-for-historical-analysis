...
\NormalTok{hansard\_1850\_with\_metadata }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{column\_spec}\NormalTok{(}\DecValTok{2}\NormalTok{, }\AttributeTok{width =} \StringTok{"7cm"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}   \CommentTok{\# wrap the "text" column}
  \FunctionTok{column\_spec}\NormalTok{(}\DecValTok{4}\NormalTok{, }\AttributeTok{width =} \StringTok{"4cm"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{tabular}{l>{\raggedright\arraybackslash}p{7cm}l>{\raggedright\arraybackslash}p{4cm}}
\toprule
