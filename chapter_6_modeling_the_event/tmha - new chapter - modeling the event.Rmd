...
Previously, we demonstrated techniques were we worked with chunks of the data at a time to save computer memory. We chunked the data so the code will be able to process it on a laptop. 
