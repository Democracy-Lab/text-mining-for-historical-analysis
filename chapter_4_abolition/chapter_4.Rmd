...
most_distinctive_words_per_abolition_speaker %>%
  ...
  labs(title = "Speakers\' Most Distinctive Words", # label the visualization with a title
       ...
       caption = "Pale shading indicates greater distinctiveness", # text for the subtitle
       x = "Word", # x axis label
...
my_words_w_tfidf <- tfidf_per_top_slavery_speaker_1833 %>% 
  filter(speaker == "Mr. Buckingham", word %in% my_words) %>% # find words spoken by Mr. Buckingham
